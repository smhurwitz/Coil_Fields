...
//    contours(Wire::hsx(0.326955182*0.1, 1e6, 1), 0, 70, "fgh"); //hifi |B| contour data
//    L_plots(100, "hifi", 1e-9,1e-9, 1e-4, Wire::hsx(0.00326955182, 1e6, 1).a_self_intersect()*0.99/0.326955182); //hifi inductance data
//    L_2D_plots(100,"lofi",1e-12,1e-12,1e-4, Wire::hsx(0.00326955182, 1e6, 1).a_self_intersect()*0.99/0.326955182); //lofi inductance data
//    L_2D_convergence_plots("L_conv",100,Wire::hsx(0.00326955182, 1e6, 1)); //data for convergence of L w.r.t aspect ratio
//    biot_conv(0.326955182/100,600,"modified",{5,12},{12,40}); //convergence of B w.r.t. modified & unmodified regularized biot-savart law
//    maxB_plots(Wire::hsx(0.00326955182, 1e6, 1),200, "maxB", 1e-3); //different ways to compute max|B|
